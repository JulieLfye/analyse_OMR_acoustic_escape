...
%                  hold on
%                  plot(indbout(1,i),vel(indbout(1,i)),'ko')
...
%                  plot(xacc,acc)
%                  hold on
                    accp = abs(diff(vel(x(1):indbout(1,i)+1)));
%                  plot(xacc(xacc<indbout(1,i)+2),accp,'r')
%                  plot(indbout(1,i)-1:1:xacc(end),acc(indbout(1,i)-1-x(1):end)+0.1,'k')
                    a = find(acc(indbout(1,i)-1-x(1):end)>5*std(accp),1)+indbout(1,i)-2;
%                  plot(a,acc(a-x(1)),'ko')
%                  figure(1)
%                  hold on
%                  plot(a,vel(a),'ro')
